...
def weekly_reference(combined_data, reference_date = date.today()):
    ...
    if (reference_date == date.today()):
        ...
        reference_day_of_week = reference_date.strftime('%A')
        return (f"Week over week reference:  \n" +
                f"28 Days Prior: {cases_twentyeight_days_ago:,}  \n" +
                f"21 Days Prior: {cases_twentyone_days_ago:,}  \n" +
                f"14 Days Prior: {cases_fourteen_days_ago:,}  \n"
                f"7 Days Prior: {cases_seven_days_ago:,}  \n"
